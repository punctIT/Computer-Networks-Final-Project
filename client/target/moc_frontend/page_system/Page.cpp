...
#include <memory>
#include "../../../src/frontend/page_system/Page.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Page_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Page_t qt_meta_stringdata_Page = {
    {
        QT_MOC_LITERAL(0, 4)   // "Page"
    },
    "Page"
};
...
Q_CONSTINIT static const uint qt_meta_data_Page[] = {
...
Q_CONSTINIT const QMetaObject Page::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Page.offsetsAndSizes,
    qt_meta_data_Page,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Page_t,
        // Q_OBJECT / Q_GADGET
